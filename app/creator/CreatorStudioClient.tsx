  ...
  return (
    <main className="creator-shell">
      ...
      <section className="creator-hero">
        ...
        <aside><strong>{publishedCount}<small>published lessons</small></strong><strong>{lessons.length - publishedCount}<small>private or hidden</small></strong><Link href={modulePaths[activeModule]} target="_blank"><Eye /> Preview {activeModule}</Link><Link href="/creator/classes"><CalendarDays /> Students & classes</Link><Link href="/creator/memberships"><CreditCard /> Memberships</Link></aside>
      </section>
