...
import { BookOpen, Check, FileKey, FileText, Headphones, Video } from "lucide-react";
import type { StudentLessonContent } from "../lib/creator-content";
import { PublishedExercises } from "./PublishedExercises";
...
export function PublishedLessonMaterials({ content }: { content?: StudentLessonContent }) {
  ...
  return <section className="published-materials" aria-label="Teacher lesson materials">
    ...
    {content.vocabulary.length > 0 && <div className="published-material-grid">
    ...
    <PublishedExercises exercises={content.exercises} />
